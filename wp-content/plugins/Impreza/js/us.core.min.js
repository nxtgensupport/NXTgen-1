...
if(e.type.indexOf('applied_coupon')>-1&&!$('.wc-block-components-notice-banner',$us.$canvas).length){$coupon.addClass('coupon_applied')}
...
var $message;if(e.type==='checkout_error'&&!!args[1]){$message=$(args[1])}else{$message=$('.wc-block-components-notice-banner',$us.$canvas)}
