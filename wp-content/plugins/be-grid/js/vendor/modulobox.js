...
( function( root, factory ) {
	...
	proto.disableZoom = function( event ) {
		...
		//BE GDPR popup switch button enable
		var touch_class = event.target.className;
		if(typeof touch_class !='undefined' && touch_class != null && (touch_class.indexOf("slider round")>-1 || touch_class.indexOf("be-gdpr-modal-save-btn")>-1)){
		}else{
			event.preventDefault();
		}
