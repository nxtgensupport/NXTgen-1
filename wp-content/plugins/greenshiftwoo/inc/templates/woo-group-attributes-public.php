...
<table class="woocommerce-group-attributes-public">
	...
	foreach( $attributes_group as $key => $attribute_group ):
		...
		?>	
			<?php if ($count > 1) :?>
			<tr class="attribute_group_row attribute_group_row_<?php echo esc_attr($key) ?>">
				<th class="attribute_group_name" colspan="2">
				<?php
					if(isset($attribute_group['img']) && !empty($attribute_group['img'])){
						echo esc_attr($attribute_group['img']);
					}
					echo esc_attr($attribute_group['name']);
				?>
				</th>
			</tr>
			<?php endif;?>
		...
		<tr class="attribute_row attribute_row_<?php echo esc_attr($key) ?>">
			<td>
