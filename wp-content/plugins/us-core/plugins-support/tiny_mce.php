...
/**
 * Don't remove supported html tags from the elements
 *
 * @param $init
 * @return mixed
 */
function us_tiny_mce_support_html_tags( $init ) {
	$init['extended_valid_elements'] = 'br,code,i,small,span,strong,sub,sup';

	return $init;
}

add_filter( 'tiny_mce_before_init', 'us_tiny_mce_support_html_tags' );
