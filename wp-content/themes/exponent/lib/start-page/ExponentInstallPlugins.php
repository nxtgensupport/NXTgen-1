...
if( !class_exists( 'ExponentInstallPlugins' ) ) {
	...
	/**
		...
		function __construct($core)
		{
			...
			$this->plugins_order = array( 'exponent-demos', 'tatsu', 'exponent-modules', 'be-grid', 'be-gdpr', 'contact-form-7',  'safe-svg',  'kirki', 'meta-box', 'meta-box-conditional-logic', 'meta-box-show-hide', 'revslider' );
		}
